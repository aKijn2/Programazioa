...
public class ErabiltzaileBalidatu 
{
     ...
     * @throws Exception 
     */
    public static boolean erabiltzaileaExistitzenDa(Connection conn, String erabiltzaileIzena) throws Exception 
    {
     ...
     * @throws Exception
     */
    public static String sortuErabiltzaileIzena(Connection conn, String izena, String abizena) throws Exception 
    {
        ...
        while (erabiltzaileaExistitzenDa(conn, erabiltzaileIzena)) 
        {
            if (i < izena.length()) 
            {
